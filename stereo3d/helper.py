...
if (camera_type == CAMERA_TYPE_PHOBOS):
    ...
    stcap = StereoCapture(
        "Image", 
        ["sample_data/deimos_left.png", "sample_data/deimos_right.png"]
    )
else:
...
if (cal_mode == CAL_MODE_IDEAL):
    ...
    stcal.get_cal_from_ideal(
        resolution, pixel_pitch, focal_length, baseline, output_folder)
    ...
    # get calibration from yaml files
    stcal = StereoCalibration()
    stcal.get_cal_from_xml(
        left_cal_file, right_cal_file, stereo_cal_file,
